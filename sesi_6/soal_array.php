...
<body>
    ...
    echo $kids[0].", ".$kids[1].", ".$kids[2].", ".$kids[3].", ".$kids[4].", ".$kids[5];
    echo "<br>";
    echo $adults[0].", ".$adults[1].", ".$adults[2].", ".$adults[3].", ".$adults[4];
    echo "<h3> Soal 2</h3>";
    /* 
            SOAL NO 2
    ...
    /*
        ...
        */
        ...
        $siswa = array (
                    ...
                    array("nama" => "Jim Hooper","Age" => 45,"Aliases" => "Chief Hopper","Status" => "Deceased"),
