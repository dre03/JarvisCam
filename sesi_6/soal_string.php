...
<body>
    ...
    <?php   
        ...
        */
        ...
        // Jawab Soal no satu
        echo "panjang string (Hello PHP!) adalah "; 
        echo strlen($first_sentence);
        echo '<br>';
        echo "jumlah kata (Hello PHP!) ";
        echo str_word_count($first_sentence);
        echo '<hr>';
        echo "pajang string (I'm ready for the challenges) adalah ";
        echo strlen($second_sentence);
        echo '<br>';
        echo "jumlah kata (I'm ready for the challenges) ";
